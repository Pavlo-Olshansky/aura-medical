...
<template>
  <div class="push-guide">
    ...
    <div v-else-if="device === 'macos'" class="guide-steps">
      ...
      <p class="guide-note">
        Якщо не працює: <strong>Системні налаштування → Сповіщення → {{ browserLabel }}</strong> — має бути увімкнено.
        Також перевірте, що режим <strong>«Не турбувати»</strong> вимкнено.
      </p>
    </div>
